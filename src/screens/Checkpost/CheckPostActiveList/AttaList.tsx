...
interface AttaListProps { }

const AttaList = (props: AttaListProps) => {
    ...
    const getActiveList = () => {
        api.getCheckpostAttaActiveList()
            .then(response => {
...
const ActiveCard = ({ item, index, removeItem }) => {
    ...
    const markReveive = () => {
        ...
        Alert.alert("Message", "You are about to acknowledge this item. Do you want to continue?", [
            ...
            {
                text: 'Yes', onPress: () => {
                    api.checkpostMarkAttaReceive(item.id)
                        .then(response => {
                            const respData = getDataFrom(response)
                            if (respData) {
            ...
            <Card.Content>
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.cell}>
                        ...
                        <Text style={styles.txtSmall}>{item.bags} ({item.atta_bardana})</Text>
                    </View>
                </View>
                ...
                <View style={styles.row}>
                    {/* <View style={styles.cell}>  */}
                    <Text style={styles.txtBold}>Dealer:{' '}</Text>
                    <Text style={styles.txtSmall}>{item.dealer_name}</Text>
                    {/* </View> */}
                </View>
