...
const DealerPendingStock = (props: DealerPendingStockProps) => {
    ...
    const renderCard = ({ item }) => <Card style={styles.card} onPress={() => navigation.navigate(Routes.RecievingForm, { item, item, refreshData: getHistory })}>
        <Card.Content>
        ...
        <Container>
            ...
            <View style={styles.container}>
                {isLoaing ?
                    ...
                    <FlatList
                        data={history}
                        ListEmptyComponent={() => <Text style={styles.label}>There's nothing in pending stock</Text>}
